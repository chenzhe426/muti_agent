...
car_rental_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "\n\nUser info:\n{user_info}"
            "\n\nIMPORTANT: The context above may include relevant history from long-term memory. "
            "Use this information to understand user's past preferences and activities."
            "\n\nCurrent time: {time}."
...
# Car rental tools
book_car_rental_safe_tools = [search_car_rentals, get_user_car_rentals]
